...
export default function CadastroProfessor() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post("http://localhost:3000/api/prof", form);
    ...
    return (
        <div>
            <div className="sidebar">
                ...
                <a href="#" className="active"><i className="fa-circle-user" ></i> AD PROFESSOR</a>
            ...
            <div style={{ maxWidth: 600, margin: "auto", padding: 20 }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    ...
                    <input type="number" name="matricula" placeholder="Número de Matrícula" value={form.matricula} onChange={handleChange} required />
